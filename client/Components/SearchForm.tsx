    ...
    >
      <div className="flex-1 relative bg-white rounded-full">
        <input
          ...
          className="w-full py-7 text-xl text-black pl-[5rem] rounded-tl-full rounded-bl-full"
        />
        <span>
          <Search
            size={30}
      ...
      <div className="flex-1 relative bg-white rounded-full">
        <input
          ...
          className="w-full py-7 text-xl text-black pl-[4rem] rounded-tr-full rounded-br-full"
        />
